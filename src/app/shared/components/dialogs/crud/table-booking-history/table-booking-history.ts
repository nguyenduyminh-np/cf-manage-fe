...
import { PosTableBooking } from '../../table-booking/pos-table-booking/pos-table-booking';
...
import { TableBookingDetail } from '../../table-booking/table-booking-detail/table-booking-detail';
