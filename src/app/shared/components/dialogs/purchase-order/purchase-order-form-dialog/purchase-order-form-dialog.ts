...
import { UiSelectComponent, UiSelectOption } from '../../../ui-component/ui-select/ui-select';
...
export class PurchaseOrderFormDialog implements OnInit {
  ...
  protected get isValid(): boolean {
    ...
    return this.details.every(
      (detail) =>
        ingredientIds.has(detail.ingredientId) && detail.quantity > 0 && detail.unitPrice >= 10000,
    );
  }
